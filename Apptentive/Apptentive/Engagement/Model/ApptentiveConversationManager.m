...
- (void)fetchEngagementManifest {
	...
	self.manifestOperation = [self.client requestOperationWithRequest:[[ApptentiveInteractionsRequest alloc] initWithConversationId:self.activeConversation.identifier] delegate:self];
