...
- (nullable instancetype)initWithCoder:(NSCoder *)coder {
	...
	if (self) {
		...
		NSSet *allowedClasses = [NSSet setWithArray:@[[NSMutableArray class], [ApptentiveAttachment class]]];
		_attachments = [coder decodeObjectOfClasses:allowedClasses forKey:AttachmentsKey];
