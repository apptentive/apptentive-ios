...
@interface ApptentiveLegacyFileAttachment ()
...
+ (instancetype)newInstanceWithFileData:(NSData *)fileData MIMEType:(NSString *)MIMEType name:(NSString *)name {
	ApptentiveLegacyFileAttachment *attachment = (ApptentiveLegacyFileAttachment *)[ApptentiveData newEntityNamed:@"ATFileAttachment"];
...
+ (instancetype)newInstanceWithJSON:(NSDictionary *)JSON inContext:(NSManagedObjectContext *)context {
	ApptentiveLegacyFileAttachment *attachment = (ApptentiveLegacyFileAttachment *)[[NSManagedObject alloc] initWithEntity:[NSEntityDescription entityForName:@"ATFileAttachment" inManagedObjectContext:context] insertIntoManagedObjectContext:context];
...
@implementation ApptentiveLegacyFileAttachment (QuickLook)
