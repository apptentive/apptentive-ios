...
- (void)testExtendedDataDate {
	...
	NSDictionary *extendedData = [Apptentive extendedDataDate:date];
...
- (void)testExtendedDataLocation {
	double latitude = 14;
	double longitude = 10;
	NSDictionary *extendedData = [Apptentive extendedDataLocationForLatitude:latitude longitude:longitude];
...
- (void)testExtendedDataCommerceItem {
	NSDictionary *commerceItem = [Apptentive extendedDataCommerceItemWithItemID:@"ID" name:@"NAME" category:@"CATEGORY" price:@(1) quantity:@(2) currency:@"CURRENCY"];
	...
	NSDictionary *nilCommerceItem = [Apptentive extendedDataCommerceItemWithItemID:nil name:nil category:nil price:nil quantity:nil currency:nil];
...
- (void)testExtendedDataCommerceTransaction {
	NSDictionary *commerceItemOne = [Apptentive extendedDataCommerceItemWithItemID:@"ID" name:@"NAME" category:@"CATEGORY" price:@(1) quantity:@(2) currency:@"CURRENCY"];
	NSDictionary *commerceItemTwo = [Apptentive extendedDataCommerceItemWithItemID:nil name:nil category:nil price:nil quantity:nil currency:nil];

	NSDictionary *commerceTransaction = [Apptentive extendedDataCommerceWithTransactionID:@"ID" affiliation:@"AFFILIATION" revenue:@(1) shipping:@(2) tax:@(3) currency:@"CURRENCY" commerceItems:@[commerceItemOne, commerceItemTwo]];
	...
	NSDictionary *nilCommerceTransaction = [Apptentive extendedDataCommerceWithTransactionID:nil affiliation:nil revenue:nil shipping:nil tax:nil currency:nil commerceItems:nil];
