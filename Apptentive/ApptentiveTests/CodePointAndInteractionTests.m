...
- (void)testGt {
	XCTAssertFalse([self.interaction criteriaAreMetForSession:self.usageData.session]);
	[self incrementCodePoint:@"test.code.point"];
	XCTAssertFalse([self.interaction criteriaAreMetForSession:self.usageData.session]);
	[self incrementCodePoint:@"test.code.point"];
	XCTAssertFalse([self.interaction criteriaAreMetForSession:self.usageData.session]);
	[self incrementCodePoint:@"test.code.point"];
	XCTAssertTrue([self.interaction criteriaAreMetForSession:self.usageData.session]);
}
