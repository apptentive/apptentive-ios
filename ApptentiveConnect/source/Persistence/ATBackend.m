...
- (void)presentMessageCenterFromViewController:(UIViewController *)viewController {
	...
	if (messageCount == 0 || ![[ATConnect sharedConnection] messageCenterEnabled] || ![ATConnect sharedConnection].useMessageCenter) {
	...
	if (currentMessagePanelController) {
		...
		if (action == ATMessagePanelDidSendMessage) {
			if (!messagePanelSentMessageAlert) {
				...
				if ([[ATConnect sharedConnection] messageCenterEnabled] && [ATConnect sharedConnection].useMessageCenter) {
