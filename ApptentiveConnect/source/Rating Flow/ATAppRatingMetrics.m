...
NSString *const ATAppRatingDidClickRatingButtonNotification = @"ATAppRatingDidClickRatingButtonNotification";

NSString *const ATAppRatingButtonTypeKey = @"ATAppRatingButtonTypeKey";
